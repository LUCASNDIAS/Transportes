...
/**
 * This is the model class for table "ordem_coleta".
 *
 * @property integer $id
 ...
 */
class OrdemColeta extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return OrdemColetaQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new OrdemColetaQuery(get_called_class());
    }
}
