...
/**
 * OrdemColetaSearch represents the model behind the search form about `backend\modules\ordemcoleta\models\OrdemColeta`.
 */
class OrdemColetaSearch extends OrdemColeta
{
    /**
     * @inheritdoc
     */
