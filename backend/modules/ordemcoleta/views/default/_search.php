...
/* @var $model backend\modules\ordemcoleta\models\OrdemColetaSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="ordem-coleta-search">
    ...
    <?php // echo $form->field($model, 'notasaltura') ?>

    <?php // echo $form->field($model, 'notaslargura') ?>

    <?php // echo $form->field($model, 'notascomprimento') ?>
