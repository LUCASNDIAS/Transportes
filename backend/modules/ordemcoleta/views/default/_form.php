...
<div class="ordemcoleta-form">

    <?php $form = ActiveForm::begin(['id' => 'ordemcoleta-form']); ?>
...
//                            'source' => $data,
                            ...
                            'select' => new JsExpression("function( event, ui ) {
									     $('#ordemcoleta-remetente').val(ui.item.cnpj); // Campo real do remetente
										 $('#ordemcoleta-remetente').focus();
                ...
                <div class="form-group">
                    ...
                    AutoComplete::widget([
                        ...
                        'clientOptions' => [
                            ...
                            'minLength' => 4,
                            'select' => new JsExpression("function( event, ui ) {
									     $('#ordemcoleta-destinatario').val(ui.item.cnpj); // Campo real do remetente
										 $('#ordemcoleta-destinatario').focus();
										 $('#consignatario-nome').focus();
										 $('#ordemcoleta-entregalocal').val(ui.item.endcid);
									}")
                        ],
                        'options' => [
                            'class' => 'form-control'
                ...
                <div class="form-group">
                    ...
                    AutoComplete::widget([
                        ...
                        'clientOptions' => [
                            ...
                            'minLength' => 4,
                            'select' => new JsExpression("function( event, ui ) {
									     $('#ordemcoleta-consignatario').val(ui.item.cnpj); // Campo real do remetente
										 $('#ordemcoleta-consignatario').focus();
										 $('#ordemcoleta-pagadorenvolvido').focus();
									}")
                        ],
                        'options' => [
                            'class' => 'form-control'
        ...
        <div class="linhas 0">
            <table class="table table-hover">
                <tr>
                    <td width="20%">
                        <div class="form-group">
                            <label class="control-label" for="ordemcoleta-notasnumero">Nota</label>
                            <?= Html::input('text', 'notasnumerox[]', (($model->isNewRecord) ? '' : $notasnumero[$i]), ['class' => 'form-control', 'id' => 'ordemcoleta-notasnumerox' . $j]); ?>
                            <p class="help-block help-block-error"></p>
                        </div>
                    </td>
                    <td width="15%">
                        <div class="form-group">
                            <label class="control-label" for="ordemcoleta-notasvalor">Valor</label>
                            <?= Html::input('text', 'notasvalorx[]', (($model->isNewRecord) ? '' : $notasvalor[$i]), ['class' => 'form-control dinheiro', 'id' => 'ordemcoleta-notasvalorx' . $j]); ?>
                            <p class="help-block help-block-error"></p>
                        </div>
                    </td>
                    <td width="15%">
                        <div class="form-group">
                            <label class="control-label" for="ordemcoleta-notasaltura">Altura</label>
                            <?= Html::input('text', 'notasalturax[]', (($model->isNewRecord) ? '' : $notasaltura[$i]), ['class' => 'form-control dimensao', 'id' => 'ordemcoleta-notasalturax' . $j]); ?>
                            <p class="help-block help-block-error"></p>
                        </div>
                    </td>
                    <td width="15%">
                        <div class="form-group">
                            <label class="control-label" for="ordemcoleta-notaslargura">Largura</label>
                            <?= Html::input('text', 'notaslargurax[]', (($model->isNewRecord) ? '' : $notaslargura[$i]), ['class' => 'form-control dimensao', 'id' => 'ordemcoleta-notaslargurax' . $j]); ?>
                            <p class="help-block help-block-error"></p>
                        </div>
                    </td>
                    <td width="15%">
                        <div class="form-group">
                            <label class="control-label" for="ordemcoleta-notascomprimento">Comprimento</label>
                            <?= Html::input('text', 'notascomprimentox[]', (($model->isNewRecord) ? '' : $notascomprimento[$i]), ['class' => 'form-control dimensao', 'id' => 'ordemcoleta-notascomprimentox' . $j]); ?>
                            <p class="help-block help-block-error"></p>
                        </div>
                    </td>
                    <td width="9%">
                        <div class="form-group">
                            <label class="control-label" for="ordemcoleta-notaspeso">Peso</label>
                            <?= Html::input('text', 'notaspesox[]', (($model->isNewRecord) ? '' : $notaspeso[$i]), ['class' => 'form-control peso', 'id' => 'ordemcoleta-notaspesox' . $j]); ?>
                            <p class="help-block help-block-error"></p>
                        </div>
                    </td>
                    <td width="9%">
                        <div class="form-group">
                            <label class="control-label" for="ordemcoleta-notasvolumes">Volumes</label>
                            <?= Html::input('text', 'notasvolumesx[]', (($model->isNewRecord) ? '' : $notasvolumes[$i]), ['class' => 'form-control', 'id' => 'ordemcoleta-notasvolumesx' . $j]); ?>
                            <p class="help-block help-block-error"></p>
                        </div>
                    </td>
                    <td width="2%">
