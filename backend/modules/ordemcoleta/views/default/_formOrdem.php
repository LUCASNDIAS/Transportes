...
<div class="ordem-coleta-form">
    ...
    <?= $form->field($model, 'notasaltura')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'notaslargura')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'notascomprimento')->textInput(['maxlength' => true]) ?>
