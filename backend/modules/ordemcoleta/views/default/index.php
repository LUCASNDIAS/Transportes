...
/* @var $searchModel backend\modules\ordemcoleta\models\OrdemColetaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Ordem Coletas');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="ordem-coleta-index">

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Create Ordem Coleta'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
<?php Pjax::begin(); ?>    <?=
    GridView::widget([
