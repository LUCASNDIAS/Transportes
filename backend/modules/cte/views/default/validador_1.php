<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="https://www.sefaz.rs.gov.br/ASP/include/AAENovo.css" />
        	<script src="//jquery.com/jquery-wp-content/themes/jquery/js/modernizr.custom.2.8.3.min.js"></script>
        <script type="text/javascript" src="https://www.sefaz.rs.gov.br/ASP/include/SEF_funcoes.js"></script>
        <script type="text/javascript" src="https://www.sefaz.rs.gov.br/ASP/include/ValidaPreenchimento.js"></script>
        ...
        <style type="text/css">
            table {border: thin;}
            .tblNFE {font-family:verdana;}
            .tdVal {color:red;font-family:verdana;font-size:12px;}
            .tdValLabel {color:#734400;font-family:verdana;font-size:12px;}
        </style>
    </head>
    <body style="margin: 0px;" onload="document.form1.txtCTe.focus();">
        <script type="text/javascript" src="https://www.sefaz.rs.gov.br/ASP/include/AAE_Cabecalho.js"></script>
        <form method="post" name="form1" action="https://www.sefaz.rs.gov.br/ASP/AAE_ROOT/CTE/SAT-WEB-CTE-VAL_1.asp" onsubmit="RotinaValidar()">
            <table width="100%" cellspacing="2" border="0">
                <tr class="linhacabec">
                    <td align="left">&nbsp;</td>
                </tr>
                <tr>
                    <td><br />Cole aqui o conte&uacute;do da mensagem <span style="font-size: 5px;"><br /><br /></span>
...
</textarea> <span style="font-size: 5px;"><br /><br /></span>
<input type="submit" value="Validar" style='width: 90px' class="button" id="submit1" name="submit1"> &nbsp;
    <input type="button" onclick="document.form1.txtCTe.value = '';document.form1.txtCTe.focus();" value="Limpar" style="width: 90px;" class="button" id="button1" name="button1"> 
        <span style="font-size: 7px;" /><br /><br /></span>
        <b style="font-family: verdana;">Resultado da Valida&ccedil;&atilde;o do Schema e Conferência da Assinatura:</b>
        <span style="font-size: 7px;"><br /><br /></span>
        <span id="txtResult" style="font-family: verdana; color: red;">
            <table class='tblCTE' width='100%' border='0'>
                <tr>
                    <td class='tdValLabel' width='5%' nowrap>PARSER XML:</td>
                    <td class='tdVal'>OK</td></tr><tr><td width='5%' nowrap class='tdValLabel'>TIPO DE MENSAGEM:</td>
                    <td class='tdVal'>CT-e</td></tr><tr><td nowrap class='tdValLabel' valign='top'>SCHEMA:</td>
                    <td class='tdVal'>The 'http://www.portalfiscal.inf.br/cte:RNTRC' element is invalid - The value '1234123423' is invalid according to its datatype 'String' - The Pattern constraint failed.</td>
                    </tr>
            </table>
        </span>
        </td>
  ...
  <br />
  <script type="text/javascript" src="https://www.sefaz.rs.gov.br/ASP/include/AAE_fim.js"></script>
</body>
</html>