...
use backend\modules\cotacao\models\Cotacao;

/**
 * CotacaoSearch represents the model behind the search form about `backend\modules\cotacao\models\Cotacao`.
 */
class CotacaoSearch extends Cotacao
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'numero', 'baixamanifesto', 'baixacoleta', 'baixaentrega', 'baixafatura', 'baixapagamento'], 'integer'],
            [['cridt', 'criusu', 'dono', 'tipofrete', 'entregalocal', 'pagadorenvolvido', 'pagadorcnpj', 'formapagamento', 'remetente', 'destinatario', 'consignatario', 'notasnumero', 'notasvalor', 'notaspeso', 'notasvolumes', 'notasaltura', 'notaslargura', 'notascomprimento', 'notasdimensoes', 'pesoreal', 'pesocubado', 'fretevalor', 'fretepeso', 'taxacoleta', 'taxaentrega', 'taxaseguro', 'taxagris', 'taxadespacho', 'taxaitr', 'taxaextra', 'taxaseccat', 'taxapedagio', 'taxaoutros', 'taxafretevalor', 'desconto', 'fretetotal', 'naturezacarga', 'status', 'manifesto', 'coletadata', 'coletahora', 'coletanome', 'coletaplaca', 'entregadata', 'entregahora', 'entreganome', 'entregadoc', 'fatura', 'pagamentorecibo', 'pagamentodata', 'tabela', 'observacoes'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'criusu', $this->criusu])
            ...
            ->andFilterWhere(['like', 'notasaltura', $this->notasaltura])
            ->andFilterWhere(['like', 'notaslargura', $this->notaslargura])
            ->andFilterWhere(['like', 'notascomprimento', $this->notascomprimento])
