...
namespace backend\modules\cotacao\controllers;

use Yii;
use backend\modules\cotacao\models\Cotacao;
use backend\modules\cotacao\models\CotacaoSearch;
...
/**
 * DefaultController implements the CRUD actions for Cotacao model.
 */
class DefaultController extends Controller
{
    ...
    /**
     * Lists all Cotacao models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new CotacaoSearch();
    ...
    /**
     * Displays a single Cotacao model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing Cotacao model.
    ...
    /**
     * Deletes an existing Cotacao model.
    ...
    public function actionPrint($id, $retorno = true) {
        ...
        $path = 'pdfs/cotacao/' . \Yii::$app->user->identity['cnpj'] . '/LNDSistemas-C' . $model->numero . '.pdf';
    ...
    public function actionSend($id) {
        ...
        if (!\Yii::$app->request->isAjax) {
            ...
            if (!is_file($anexoPDF)) {
                ...
                // Título do Email
                $titulo = 'LND Sistemas | ' . \Yii::$app->user->identity['empresa'] . ' - Cotação ' . $model->numero;
                ...
                $Envia = $EnviaEmail->Enviar($EmailDestinatario, $titulo, $anexoPDF, $dados, 'cotação');
    ...
    /**
     * Finds the Cotacao model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Cotacao the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Cotacao::findOne($id)) !== null) {
            return $model;
        } else {
