...
$this->title = Yii::t('app', 'Enviar Cotação ') . str_pad($model->numero, 6, 0, STR_PAD_LEFT);
$basicos = new Basicos();
?>

<?= Html::beginForm([Url::to(['/cotacao/default/send']), 'id' => $model->id], 'post', ['enctype' => 'multipart/form-data', 'name' => 'form-envio', 'id' => $model->id]) ?>
