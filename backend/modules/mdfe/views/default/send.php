...
<div class="cte-send">
    ...
    ?>
    <?= Html::a('Editar MDF-e', ['/mdfe/default/update', 'id' => $model->id], ['class'=>'btn btn-primary']) ?>
        ...
        <div class="col-md-4" id="bloco-gerar">
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    <p id="resultado-gerar">Aguardando confirmação de transmissão do Manifesto.</p>
        ...
        <div class="col-md-6" id="bloco-protocolo">
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    <p id="resultado-protocolo">MDF-e não autorizado.</p>
        ...
        <div class="col-md-6" id="bloco-pdf">
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    <p id="resultado-pdf">MDF-e não autorizado.</p>
