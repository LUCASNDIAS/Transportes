...
<div class="mdfe-form">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-sm-2"><?=
                    $form->field($model, 'uf')->textInput([
                        'readonly' => true, 'value' => 'MG'])
                    ?></div>
                <div class="col-sm-3"><?=
                    $form->field($model, 'dtemissao')->textInput([
                        'readonly' => true, 'value' => date("Y-m-d\TH:i:sP")])
                    ?></div>
                <div class="col-sm-3"><?=
            ...
            <div class="row">
                <div class="col-sm-6"><?=
                    $form->field($model, 'ufcarga')->dropDownList($ufs,
                        ['prompt' => '-- Selecione --'])
                    ?></div>
                <div class="col-sm-6"><?=
                    $form->field($model, 'ufdescarga')->dropDownList($ufs,
                        ['prompt' => '-- Selecione --'])
                    ?></div>
            </div>
        </div>
                ...
                <div class="item panel panel-default"><!-- widgetBody -->
                    ...
                    <div class="panel-body">
                        ...
                        if (!$modelPercurso->isNewRecord) {
                            ...
                            echo Html::activeHiddenInput($modelPercurso,
                                "[{$index}]id");
                        }
                        ?>
                ...
                <div class="panel-body container-items-car"><!-- widgetContainer -->
                    ...
                    <?php foreach ($modelsCarregamento as $index => $modelCarregamento): ?>
                        ...
                        <div class="item-car panel panel-default"><!-- widgetBody -->
                            ...
                            <div class="panel-heading">
                                <span class="panel-title-carregamento">Município: <?=
                                    ($index + 1)
                                    ?></span>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <?=
                                        $form->field($modelCarregamento,
                                            "[{$index}]cMun")->textInput([
                                            'maxlength' => true,
                                            'readonly' => true])
                                        ?>
                                    </div>
...
<?php foreach ($modelsDescarregamento as $index => $modelDescarregamento): ?>
                        ...
                        <div class="item-des panel panel-default"><!-- widgetBody -->
                            ...
                            <div class="panel-heading">
                                <span class="panel-title-descarregamento">Município: <?=
                                    ($index + 1)
                                    ?></span>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <?=
                                        $form->field($modelDescarregamento,
                                            "[{$index}]cMun")->textInput([
                                            'maxlength' => true,
                                            'readonly' => true])
                                        ?>
                ...
                <div class="item-con panel panel-default"><!-- widgetBody -->
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <?=
                                $form->field($modelCondutor,
                                    "[{$index}]condutor")->textInput([
                                    'maxlength' => true,
                                    'readonly' => true])
                                ?>
                            </div>
...
<?php DynamicFormWidget::end(); ?>
            ...
            <div class="row">
                <div class="col-sm-4"><?=
                    $form->field($model, 'rntrc')->textInput([
                        'readonly' => true, 'value' => '10167059'])
                    ?></div>
                <div class="col-sm-4"><?=
                    $form->field($model, 'ciot')->textInput([
                        'maxlength' => true])
                    ?></div>
                <div class="col-sm-4"><?=
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body container-items-doc"><!-- widgetContainer -->
                ...
                <div class="item-doc panel panel-default"><!-- widgetBody -->
                    ...
                    <div class="panel-heading">
                        <span class="panel-title-documentos">Documento: <?=
                            ($index + 1)
                            ?></span>
    ...
    <?=
    Html::input('text', 'documento-0-busca', null,
    ...
    ?>
                            ...
                            <div class="col-sm-4">
    <?=
    $form->field($modelDocumentos, "[{$index}]valor")->textInput([
        'readonly' => true,
    ])
    ?>
                            </div>
...
<?php DynamicFormWidget::end(); ?>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-sm-4"><?=
$form->field($model, 'qtdecte')->textInput([
    'value' => '1'])
?></div>
            ...
            <div class="row">
                <div class="col-sm-4"><?=
                    $form->field($model, 'valormercadoria')->textInput(['class' => 'form-control obrig-din'])
                    ?></div>
                <div class="col-sm-4"><?=
                    $form->field($model, 'unidademedida')->dropDownList([
                        '01' => 'Kg',
                        '02' => 'Ton'
                    ])
                    ?></div>
                <div class="col-sm-4"><?=
                    $form->field($model, 'pesomercadoria')->textInput([
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-sm-6"><?=
                    $form->field($model, 'inffisco')->textarea([
                        'maxlength' => true])
                    ?></div>
                <div class="col-sm-6"><?=
                    $form->field($model, 'infcontribuinte')->textarea(['maxlength' => true])
                    ?></div>
            </div>
        </div>
    ...
    <div class="form-group">
        ...
        Html::submitButton($model->isNewRecord ? Yii::t('app',
                    'Salvar Informações') : Yii::t('app', 'Update'),
