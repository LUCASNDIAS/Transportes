...
$dhEmi = '2017-12-29T00:20:00-02:00';
$numeroMDFe = 106; //rand(0,3345678);
...
$resp = $mdfe->tagInfMunCarrega(
    $cMunCarrega = '3301009',
    $xMunCarrega = 'CAMPOS DOS GOYTACAZES'
);
...
$resp = $mdfe->tagInfCTe(
        $nItem = 0,
        $chCTe = '31171209204054000143570010000020211098357830',
        $segCodBarra = ''
    );

$resp = $mdfe->tagInfCTe(
        $nItem = 0,
        $chCTe = '31171209204054000143570010000020221098357838',
        $segCodBarra = ''
    );

$resp = $mdfe->tagInfCTe(
        $nItem = 0,
        $chCTe = '31171209204054000143570010000020231098357835',
        $segCodBarra = ''
    );

$resp = $mdfe->tagInfCTe(
        $nItem = 0,
        $chCTe = '31171209204054000143570010000020241098357832',
        $segCodBarra = ''
    );

$resp = $mdfe->tagInfCTe(
        $nItem = 0,
        $chCTe = '31171209204054000143570010000020251098357830',
        $segCodBarra = ''
    );

$resp = $mdfe->tagInfCTe(
        $nItem = 0,
        $chCTe = '31171209204054000143570010000020261098357837',
        $segCodBarra = ''
    );

$resp = $mdfe->tagInfCTe(
        $nItem = 0,
        $chCTe = '31171209204054000143570010000020271098357834',
        $segCodBarra = ''
    );

$resp = $mdfe->tagInfCTe(
        $nItem = 0,
        $chCTe = '31171209204054000143570010000020281098357831',
        $segCodBarra = ''
    );

$resp = $mdfe->tagInfCTe(
        $nItem = 0,
        $chCTe = '31171209204054000143570010000020291098357839',
        $segCodBarra = ''
    );

$resp = $mdfe->tagInfCTe(
        $nItem = 0,
        $chCTe = '31171209204054000143570010000020301098357830',
        $segCodBarra = ''
    );
