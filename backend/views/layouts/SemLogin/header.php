...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini">LND</span><span class="logo-lg">' . Yii::$app->name . '</span>', Yii::$app->homeUrl, ['class' => 'logo'])?>
		...
		<div class="navbar-custom-menu">
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user user-menu"><a href="#"
					...
					<?php echo Html::img('@web/img/user.jpg', 
							['class'=>'user-image']);?> <span class="hidden-xs"><?php echo "Teste";// $this->params['DadosUsuario']['nome']; ?></span>
				</a>
					<ul class="dropdown-menu">
						<!-- User image -->
						<li class="user-header"><img
							...
							<p>
                                <?php //$this->params['DadosUsuario']['nome']; ?>
                                <small>
                                <?php
								/*																								
								if ($this->params ['DadosUsuario']['adm'] == 1) {
									echo "-- Administrador --"; 
								} else {
									echo '-- Usu�rio Padr�o --';
								} */
						...
						<li class="user-footer">
							<div class="pull-left">
								<?= Html::a(
										'Dados',
										['@web/clientes/listar?cnpj=11095658000140'],
