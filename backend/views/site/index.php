    ...
    <div class="body-content">
        ...
        <div class="row">
            <div class="col-lg-3" align="center">
                ...
                <p>Emita Conhecimentos de Transporte Eletr&ocirc;nico.</p>
            ...
            <div class="col-lg-3" align="center">
                ...
                <p>Emita Manifesto Eletr&ocirc;nico.</p>

                <p>
                    <?= Html::a('Buscar', '@web/mdfe', array('class' => 'btn btn-default')); ?>
                    <?= Html::a('Emitir', '@web/mdfe/default/create', array('class' => 'btn btn-default')); ?>
                </p>
            </div>
            <div class="col-lg-3" align="center">
                <h2>Faturas</h2>

                <p>Gere faturas de CT-e e Minutas.</p>
