...
/**
 * CteController implements the CRUD actions for Cte model.
 */
class CteController extends Controller
{
    ...
    {
        $model = new Cte();
//        $modelNotas = new \backend\models\CteNotas();
        
        // AutoComplete de Clientes
        $autocomplete = new \backend\models\Clientes;
        $data = $autocomplete->autoComplete();
        
        $post = (Yii::$app->request->post() !== null) ? Yii::$app->request->post() : null;
