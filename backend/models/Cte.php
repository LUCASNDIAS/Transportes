...
class Cte extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['dono', 'tomador', 'emitente', 'remetente', 'destinatario', 'expedidor', 'recebedor'], 'string', 'max' => 14],
            ...
            [['taxaextra', 'desconto', 'infNF', 'rodo', 'entrega_doc'], 'string', 'max' => 15],
     ...
     */
    public function getCteNotas()
    {
        return $this->hasOne(CteNotas::className(), ['id' => 'id']);
    }
